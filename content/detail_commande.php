...
<h2>Détail de la commande #<?= $id_commande ?></h2>
    ...
    <table class="table table-bordered table-striped">
        ...
        <tbody>
            <?php foreach ($details as $detail): ?>
                ...
                <?php
                $boisson = $boissonDAO->getBoissonById($detail->id_boisson);
...
<a href="index_.php?page=mes_commandes.php" class="btn btn-secondary">
